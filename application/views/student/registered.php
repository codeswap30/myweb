                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="#"><i class="fa fa fa-server"></i> <span>Student Manager</span></a></li>      
                                        </ul>
                                    </li>
                                    <?php
                                        }
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel">
                                            ...
                                            $error = "NONE OF YOUR STUDENT ARE OFFERING ".strtoupper(str_replace('_',' ',$offer)).'<br/> <a href="'.site_url('student/edit').'" style="text-deocoration:underline;font-weight:bold;">CLICK HERE TO CHECK</a>';?>
<?php if(isset($msg)){?>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result['Religious']);?></td>
                                                            <td><?php echo htmlentities($result['Post']);?></td>
                                                            
                                                            <td>
                                                            <input type="hidden" id="name" value="<?php echo $result['id']?>">
                                                            <button type="button" onclick="read_move('<?php echo $result['id']?>')" class="btn"><i class="fa fa-edit" title="Edit Record"></i></button> 
...
function read_move(d){
    var xhtml;       
    var nas = document.getElementById('id02');
    nas.style.display = 'block';
        ...
        xhtml.open("POST","<?php echo site_url('student/forms');?>");
        xhtml.send(data);
        }catch(e){
            alert(e.message);
        }
