                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url();?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Student CA Manager</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="<?php echo site_url('student/classes/'.str_replace(' ','_',$c));?>">return to Class</a></li>
            						</ul>
                                </div>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result['CA1']);?></td>
                                                            <td><?php echo htmlentities($result['CA2']);?></td>
                                                            <td><?php echo htmlentities($result['MTT']);?></td>
...
if(strtolower($type)=='subject'){
    if(isset($subjectname) && !empty($subjectname) || $subjectname!=""){
        $_subject_array = explode(',',strtolower($subjectname));
        
        if(in_array($sub, $_subject_array)){

            ?>

<a href="<?php echo site_url('student/compute/'.$sub.'_'.$result['id'])?>"><i class="fa fa-edit" title="compute CA"></i></a> 
    <?php
