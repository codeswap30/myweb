                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                           ...
                                           <!-- <li><a href="<?php echo site_url('student/register');?>"><i class="fa fa-bars"></i> <span>Report Sheet Manager</span></a></li> -->
                            ...
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                  ...
                                  <ul class="breadcrumb" style="background-color:#fff;">
                                        <li><a href="<?php echo site_url('home/dashboard');?>"><i class="fa fa-backward"></i> Back</a></li>
                                  </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                            </div>
                        ...
                        <section class="section">
                            <div class="container-fluid">
                                <div class="row">
                                        ...
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('student/subject/'.$result['id']);?>">
                                            <span class="name"><?php echo str_replace('jss_','',$result['SubjectName']);?></span>
...
<?php
                                            ...
                                            $ss = "";
                                        if(!is_null($subjectEx) && ($classname != str_replace('_',' ',$current))){
                                            $subjectEx = explode(',',$subjectEx);
                                            
                                            if(count($datastring)>0){
                                                foreach($datastring as $result){
                                                    if(in_array($result['SubjectName'],$subjectEx)){
                                                        $ss = strtolower(explode('_',$result['SubjectName'])[0]);
                                        
                                                ?>
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-botton:16px;">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('student/subject/'.$current.'_'.$result['id']);?>">
                                            <span class="name"><?php echo  str_replace($ss.'_','',$result['SubjectName']);?></span>
                                            <span class="bg-icon"><i class="fa fa-info-circle"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    <!-- /.col-lg-3 col-md-3 col-sm-6 col-xs-12 -->
                                            ...
                                            if(count($datastring)>0){
                                                foreach($datastring as $result){
                                                    if(strpos($result['SubjectName'],'_')!==FALSE){
                                                        $ss = explode('_',$result['SubjectName'])[0];
                                                    }                              
