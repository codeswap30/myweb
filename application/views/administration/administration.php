    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/registered');?>">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/classm');?>">
                                            <span class="name">Class Manager</span>
                                            <span class="bg-icon"><i class="fa fa-bank"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/subjectm');?>">
                                            <span class="name">Subject Manager</span>
                                            <span class="bg-icon"><i class="fa fa-bank"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/products');?>">
                                            <span class="name">Video Manager</span>
                                            <span class="bg-icon"><i class="fa fa-bank"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-top:8px;">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/teacher');?>">
                                            <span class="name">Teacher Manager</span>
                                            <span class="bg-icon"><i class="fa fa-bank"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                ...
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-top:8px;">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/gallary');?>">
                                            <span class="name">Gallary</span>
                                            <span class="bg-icon"><i class="fa fa-bank"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-top:8px;">
                                        <a class="dashboard-stat bg-success" href="<?php echo site_url('admin/video');?>">
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "<?php if(isset($_SESSION['admin'])) echo $_SESSION['admin'];?> Welcome to Adminsitration Dashboard!");
