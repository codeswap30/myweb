                                        ...
                                        <?php } ?>
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="subject" value="<?php echo htmlentities($subject);?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- english, mathematics etc</span>
                                                		</div>
                                                	</div>
                                                     <div class="form-group has-success">
