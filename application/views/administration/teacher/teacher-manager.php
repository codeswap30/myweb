                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><a href="<?php echo site_url('register/teacher');?>"><i class="fa fa-user"></i> Register Teacher</a></li>
            						</ul>
                                </div>
...
<?php $cnt=$cnt+1;}} ?>
        ...
        <div id="id02" class="modals">
            ...
            <form class="modals-content animate" action="<?php echo site_url('admin/teacher')?>" method="post">
                <fieldset>
...
function read_move(d){
    ...
    nas.style.display = 'block';
        ...
        xhtml.open("POST","<?php echo site_url('admin/forms');?>");
        xhtml.send(data);
        }catch(e){
            alert(e.message);
        }
