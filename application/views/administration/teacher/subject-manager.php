                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Subjects Manager</li>
            							<li><button class="btn btn-primary" onclick="document.getElementById('id02').style.display='block'">Add Subject</button></li>
            						</ul>
                                </div>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities(str_replace($result['Section'].'_','',$result['SubjectName']));?></td>
                                                            <td><?php echo htmlentities($result['Section']);?></td>
                                                            <td><?php echo htmlentities($result['Time_Add']);?></td>
<td>
<a href="<?php echo site_url('admin/subjectm/'.$result['id'])?>"><i class="fa fa-remove" title="Delete Record"></i> Delete Subject</a> 
                ...
                <div class="form-group has-success">
                    ...
                    <div class="">
                        <select name="section" class="form-control" required="required" id="section">
                            ...
                            <option value="allnps">All (Nursery, Primary and Secondary)</option>
                            <option value="allps">All (Primary and Secondary)</option>
                            <option value="alljs">All (Junior and Senior Secondary)</option>
