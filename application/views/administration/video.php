                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><button class="btn btn-primary" onclick="document.getElementById('id02').style.display='block'">Create Folder</button></li>
            						</ul>
                                </div>
...
<td><a href="<?php echo site_url('admin/open/videoss_'.$row['Image']);?>"><img src="<?php echo base_url('img/icon/picture.jpeg')?>" style="width:10%"></a></td>
<td><a href="<?php echo site_url('admin/open/videoss_'.$row['Image']);?>"><?php echo $row['Image'];?></a></td>
<td><?php echo $row['Type'];?></td>
<td><a href="<?php echo site_url('admin/video/'.$row['id']);?>">Delete</a></td>
</tr> 
<?php
                                }
                            }
        ...
        <div id="id02" class="modals">
            ...
            <form class="modals-content animate" action="<?php echo site_url('admin/video')?>" method="post">
                <label for="section" class="col-sm-2 control-label">Enter Folder Name</label>
                <input type="text" name="folder" class="form-control" id="folder" placeholder="Enter Folder Name" required="required" autocomplete="off">
                <button type="submit" name="submit-folder" class="btn btn-primary">Create Folder</button>
            </form>
        </div>
