                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage Gallary</h2>
...
<td><a href="<?php echo site_url('admin/open/'.$row['Image']);?>"><img src="<?php echo base_url('img/icon/picture.jpeg')?>" style="width:10%"></a></td>
<td><a href="<?php echo site_url('admin/open/'.$row['Image']);?>"><?php echo $row['Image'];?></a></td>
...
<?php
        ...
        <div id="id02" class="modals">
            ...
            <form class="modals-content animate" action="<?php echo site_url('admin/gallary')?>" method="post">
